...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"scripts/app.js":[function(require,module,exports) {
"use strict";
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } //import axios
// Select elements from the DOM
var searchForm = document.querySelector('#search-form');
var searchInput = document.querySelector('#search-input');
var resultsContainer = document.querySelector('#results');
var apiKey = '40db974f836a4c99af3584081fbcdc5d';

// Select elements for ingredients
var ingredientsForm = document.querySelector('#ingredients-form');
var ingredientsInput = document.querySelector('#ingredients-input');
...
if (ingredientsForm) {
  ingredientsForm.addEventListener('submit', /*#__PURE__*/function () {
...
function getRecipes(query) {
  fetch("https://api.spoonacular.com/recipes/complexSearch?apiKey=".concat(apiKey, "&query=").concat(query)).then(function (response) {
    return response.json();
  }).then(function (data) {
    return displayRecipes(data.results);
  }).catch(function (error) {
    return console.error('Error:', error);
  });
}
function getRecipesByIngredients(_x2) {
  return _getRecipesByIngredients.apply(this, arguments);
}
function _getRecipesByIngredients() {
  _getRecipesByIngredients = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ingredients) {
    var url, response, recipes;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          url = "https://api.spoonacular.com/recipes/findByIngredients?apiKey=".concat(apiKey, "&ingredients=").concat(ingredients);
          _context2.prev = 1;
          _context2.next = 4;
        ...
        case 9:
          ...
          console.error('Error retrieving recipes:', _context2.t0);
...
function displayRecipes(recipes) {
  ...
  if (resultsContainer) {
    var html = recipes.map(function (recipe) {
      var recipeLink = "<a href=\"recipe.html?id=".concat(recipe.id, "\">Go to Recipe</a>");
